...
//always make a habit of mentioning this declaration and description in the generic library scripts.
...
public class JavaLibrary {
    ...
    {
   	 Date d = new Date();
   	 String date = d.toString();      // System's date is converted to string
   	 return date;
    ...
    {
    	Date d = new Date();
    	String[] dArr = d.toString().split(" ");        //Converting system date format to a specific format
    	String month = dArr[1];                           
        String date = dArr[2];                                      
    	String year = dArr[5];
